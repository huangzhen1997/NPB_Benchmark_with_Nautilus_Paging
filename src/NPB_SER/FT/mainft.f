...
c         write(*, 1000)
c         write(*, 1001) nx, ny, nz
c         write(*, 1002) niter
c         write(*, *)
         call write_1000()
         call write_1001(nx, ny, nz)
...
!
c         if( total_time .ne. 0. ) then
c           mflops = 1.0d-6*float(ntotal) *
c     >             (14.8157+7.19641*log(float(ntotal))
c     >          +  (5.23518+7.21113*log(float(ntotal)))*niter)
c     >                 /total_time
c         else
c           mflops = 0.0
c         endif
